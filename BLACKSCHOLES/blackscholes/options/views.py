...
def calculate_option(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            # Calculate option price using the Black-Scholes function
            option_price = black_scholes(stock_price, strike_price, time_to_maturity, risk_free_rate, volatility, option_type)
